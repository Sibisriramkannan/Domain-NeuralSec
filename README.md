...
| Category | Type | Agents | Execution | Vulnerability Checks |
|----------|------|--------|-----------|----------------------|
...
Launches automatically in a new terminal window:
...
```python
# Prevents module collision between identical
...
![Ethical](https://img.shields.io/badge/Ethical-Hackers%20Only-red?style=for-the-badge&logo=hackthebox)
